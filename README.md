# 10 Linguagens que Você Precisa Conhecer

**Integrantes:** Gabriel Dourado

## Descrição do Projeto

Site desenvolvido para a disciplina de Desenvolvimento Web, apresentando 10 linguagens de programação populares. Para cada linguagem, o site traz o ano de criação, o(s) criador(es) e as principais áreas de aplicação. O projeto também conta com uma página de formulário para avaliação do site e uma página sobre os desenvolvedores (alguns são fictícios).
...
### Dia 1
- Estruturação inicial do `index.html`, ainda estava aprendendo sobre o uso então deixei só uma estrutura pronta.
- Criação do conteúdo das 10 linguagens de programação (texto, imagens e links) para inserir na página.

### Dia 2
- Criação do formulário de avaliação (`contact.html`) com os diferentes tipos de `input`.
- Adição do conteúdo no site.

### Dia 3
- Criação da página `about.html` com informações sobre os desenvolvedores.
- Revisão geral do checklist e organização do README.