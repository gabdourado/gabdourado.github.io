...
- [x] 5. Alterar o favicon (a imagem exibida no canto à esquerda do título da página)
...
- [x] 10. Demais tags comuns no HTML: `<img />` (com `width`/`height`), `<a>`, `<h1>` a `<h6>`, `<p>`, `<br>`, `<table>`, `<ul>`/`<li>`, `<div>`
